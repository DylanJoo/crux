...
python -m pyserini.search.lucene \
    ...
    --index ${CRUX_CORPUS_ROOT}/indices/bm25.crux.crux-mds-corpus.lucene \
    --topics ${TOPIC_PATH/jsonl/tsv} \
    --output ${HOME}/crux/runs/bm25.default.crux-mds-duc04.txt \
    --bm25 --k1 0.9 --b 0.4
...
python -m pyserini.search.lucene \
    ...
    --index ${CRUX_CORPUS_ROOT}/indices/bm25.crux.crux-mds-corpus.lucene \
    --topics ${TOPIC_PATH/jsonl/tsv} \
    --output ${HOME}/crux/runs/bm25.default.crux-mds-multi_news.txt \
    --bm25 --k1 0.9 --b 0.4
