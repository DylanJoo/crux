...
instruction_request = "Create a statement of report request that corresponds to the given report. Write a report request of approximately 50-100 words within <r> and </r> tags."
